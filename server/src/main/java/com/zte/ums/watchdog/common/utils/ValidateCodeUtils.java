...
public class ValidateCodeUtils {
    ...
    private static HashMap<String , String> ValidateCodeMap = new HashMap<String , String>();

    public static HashMap<String, String> getValidateCodeMap() {
    ...
    public static void createImage(HttpServletRequest request,
                                   HttpServletResponse response,String reToken) throws IOException {
